...
<div class="page-title">
    <div>
        <h1><i class="fa fa-file-o"></i>Cập nhập tin tức</h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Cập nhập tin tức</h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <?= form_dropdown(['class' => 'form-control input-sm', 'name' => 'CategoriesID', 'value' => 'categories'], $list, $info->CategoriesID); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label">Tên tin tức</label>
                        <div class="col-sm-9 col-lg-10 controls">
                            <input placeholder="Nhập tên tin tức..." class="form-control input-sm" value="<?= $info->Title ?>" name="Title" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input class="form-control input-sm" name="image" value="<?= $info->Images_Url ?>" type="file">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input placeholder="Từ khoá..."  class="form-control input-sm" value="<?= $info->Keyword ?>" name="Keyword" type="text">
                        </div>
                    </div>
                    <div class="form-group">
