...
<html>
    ...
    <!-- Mirrored from shamsoft.net/flaty/table_advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Sep 2015 07:25:03 GMT -->
    <head>
        <meta charset="utf-8">
        ...
        <div class="container" id="main-container">
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="active"><a href="table_advance.html">Advance</a></li>
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-file-o"></i> Advance Table</h1>
                                    ...
                                    <table class="table table-advance">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><a class="sort-asc sort-desc" href="#">Rendering engine</a></th>
                                                <th><a class="sort-asc sort-desc" href="#">Browser</a></th>
                                                <th><a class="sort-asc sort-desc" href="#">Platform(s)</a></th>
                                                <th><a class="sort-asc sort-desc" href="#">Engine version</a></th>
                                                <th><a class="sort-asc sort-active" href="#">CSS grade</a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="table-flag-blue">
                                                <td><input type="checkbox" /></td>
                                                <td>Trident</td>
                                                <td><span class="label label-warning">So crazy!</span> Internet Explorer 6</td>
                                                <td>Win 98+</td>
                                                <td>6</td>
                                                <td>A</td>
                                            </tr>
                    ...
                    <div class="col-md-12">
                        <div class="box box-green">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right">
                                    <div class="btn-group">
                                        <a class="btn btn-circle btn-bordered btn-fill btn-to-success show-tooltip" title="Add new record" href="#"><i class="fa fa-plus"></i></a>
                                            ...
                                            <tr class="table-flag-blue">
                                                ...
                                                <td class="visible-md visible-lg">
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="btn btn-sm show-tooltip" title="Edit" href="#"><i class="fa fa-edit"></i></a>
                                                        <a class="btn btn-sm btn-danger show-tooltip" title="Delete" href="#"><i class="fa fa-trash-o"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-magenta">
                            <div class="box-title">
                                <h3><i class="fa fa-table"></i> Advance Table Flags</h3>
                                <div class="box-tool">
                                    <a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
                                    <a data-action="close" href="#"><i class="fa fa-times"></i></a>
                                </div>
                            ...
                            <div class="box-content">
                                <table class="table table-advance">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-flag-blue">
                                            <td><code>table-flag-blue</code></td>
                                        </tr>
                                        <tr class="table-flag-green">
                                            <td><code>table-flag-green</code></td>
                                        </tr>
                                        <tr class="table-flag-red">
                                            <td><code>table-flag-red</code></td>
                                        </tr>
                                        <tr class="table-flag-orange">
                                            <td><code>table-flag-orange</code></td>
                                        </tr>
                                        <tr class="table-flag-yellow">
                                            <td><code>table-flag-yellow</code></td>
                                        </tr>
                                        <tr class="table-flag-lime">
                                            <td><code>table-flag-lime</code></td>
                                        </tr>
                                        <tr class="table-flag-pink">
                                            <td><code>table-flag-pink</code></td>
                                        </tr>
                                        <tr class="table-flag-magenta">
                                            <td><code>table-flag-magenta</code></td>
                                        </tr>
                                        <tr class="table-flag-gray">
                                            <td><code>table-flag-gray</code></td>
                                        </tr>
                                        <tr class="table-flag-black">
                                            <td><code>table-flag-black</code></td>
                                        </tr>
                                    </tbody>
                                </table>
